...
export default function Conversation({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        'group relative flex h-12 w-full items-center rounded-lg outline-none transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring md:h-9',
        isActiveConvo || isPopoverActive
          ? 'rounded-l-none bg-surface-active-alt text-primary before:absolute before:inset-y-0 before:left-0 before:w-[3px] before:bg-primary hover:bg-primary/15'
          : 'hover:bg-accent',
      )}
      role="button"
