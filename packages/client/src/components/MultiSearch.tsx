...
export default function MultiSearch({
  ...
  return (
    ...
    >
      <Search
        className="h-4 w-4 text-text-secondary transition-colors duration-200 group-focus-within:text-text-primary"
        aria-hidden={'true'}
      />
      <input
        ref={inputRef}
      ...
      <button
        className={cn(
          'relative flex h-5 w-5 items-center justify-end rounded-md text-text-secondary hover:text-text-primary',
